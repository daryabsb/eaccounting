...
class AccountModelAdmin(admin.ModelAdmin):
    ...
    search_fields = ["id", "name", "account_type",
...
class JournalModelAdmin(admin.ModelAdmin):
    list_display = ["id", "name", "journal_type",
                    "defualt_credit_account_id", "defualt_credit_account_id"]
    list_display_links = ["id", "name", "journal_type",
                          "defualt_credit_account_id", "defualt_credit_account_id"]
    list_filter = ["id", "name", "journal_type",
                   "defualt_credit_account_id", "defualt_credit_account_id"]
    search_fields = ["id", "name", "journal_type",
                     "defualt_credit_account_id", "defualt_credit_account_id"]
